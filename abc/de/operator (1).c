...
int main(void)
{
	...
	//       output should be wrong, 结果应该为浮点型，用%d打印是错误的
...
int main(void)
{
	...
	if(!a) // better to use explicit comparison i.e. a == 0， 0表示错，其他数字都表示对
	{
...
int main(void)
{
	...
	//       value of b is unchanged，因为第一个对了，直接不看第二个
