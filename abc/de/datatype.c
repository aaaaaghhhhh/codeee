...
int main(void)
{
	...
	// NOTE: that 'a' doesn't go beyond 255,��Ϊunsigned char �� 0-255 
...
//-------------------------------- example 5 ----------------------------------
/*#include <stdio.h>
#include <limits.h> //ȷ�����ֱ������͵����ԡ� ʵ���ϣ������˸��ֱ������͵�ֵ�����ַ������ͺͳ����� 
...
int main(void)
{
	...
	do
	{
		...
		else if((new + tickets) > UCHAR_MAX) //UCHAR_MAX:255 defines the max value for an unsigned char
		{
...
int main(void)
{
	...
	// %d �Ǵ�ӡint�͵ģ�1.23456789�Ǹ����ͣ�Ҫ��%f��ӡ 
	// float �����ȸ������ڻ���ռ4 ���ֽڣ���32 λ������������ 
	//double ˫���ȸ������ڻ���ռ8 ���ֽڣ���64 λ������������ 
	// �������ڻ�����ָ����ʽ��ʾ���ֽ�Ϊ��������β����ָ������ָ���Ĳ��֡� 
	// ����ռ1 λ�����ƣ���ʾ���������� 
	printf("\t%f", 1.23456789); //����6λС��������������1.234568 
	printf("\t%.2f", 1.23456789); // ����2λС������������ 
	printf("\t%.4f", 1.23456789);
	
	short myshort = 32768; // short: -32768~32767  
	printf("\n%d", myshort);
	// ����������-32768 
	// ����ĳ�32769�����������-32767 
...
int main(void)
{
	...
	printf("\n\n%11.9f", 1.23456789); //�ֶγ���Ϊ11λ,С���㱣��9λ,�����������,�����Ҷ���,�ֶβ����ÿո���� 
	printf("\n%11.8f", 1.23456789);
	printf("\n%11.7f", 1.23456789);
	printf("\n%11.6f", 1.23456789);
	printf("\n%11.5f", 1.23456789);
...
int main(int argc, char *argv[]) //main(int argc,char *argv[])�����������βΣ�
//��һ��int argc���Ǽ�¼�������������У�����Ŀ��˵�Ĳ����������������룩�ϵ���
//���������� �ڶ���*argv[]�Ǹ�ָ�����飬����������������ϵ�����ַ������� 
//���磺������������PROG ABCDEFGH IJKLʱ��
//��¼��3���ַ������Լ��Ϊ�磬�������������Լ������
// *argv[0]�зŵ���"PROG"��*argv[1]�зŵ���"ABCDEFGH"��
// *argv[2]�зŵ���"IJKL"������argc����3��
{
   int wind = -1;
   ...
   if(wind < 0)
   {
	  ...
	  // exit(1)��ʾ�쳣�˳������˳�ǰ���Ը���һЩ��ʾ��Ϣ�����ڵ��Գ����в쿴����ԭ��
   ...
   //      and compare the output
   // 没有exit 会执行下一个if，如果有exit，在执行完当前的if之后，直接停止
...
int main(void)
{
	...
	c = (a >= 10) && (++b >= 15); // ++b 用的是新值 也就是21
	
	printf("a = %d, b = %d, and c = %d\n", a, b, c);
	// a=10 b=21 c=1 因为true
...
int main(int argc, char *argv[])
{
   ...
   double diff = fabs((x_squared + y_squared) - z_squared); //fabs属于C语言中的库函数，用于求浮点数x的绝对值
   double epsilon = 0.00000000000001; //Single.Epsilon 字段表示大于零的最小正Single值。此字段为常数。
   // Double.Epsilon 字段 表示大于零的最小正Double值。此字段为常数。
